...
The required CodeQL PR scan subsequently identified exponential backtracking in the training-target expression. Possessive word/list matching prevents those ambiguous retries. The 2026-09-24 regression tests both malformed long input and supported compound training instructions; all 37 tests pass.
