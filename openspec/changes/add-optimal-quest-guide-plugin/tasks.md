...
- [x] 9.10 Apply Creating new plugins steps 6–8 with com.questcape and renamed plugin/config/launcher classes; verify metadata/build references, the root icon and feature README for steps 10–11, and publish the refactor. Clean build passes 45 tests; JAR registration/package and launcher checks pass. In-game confirmation of the renamed entry point remains a user check.
