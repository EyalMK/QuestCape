...
import com.optimalquestguide.progress.AccountProgress;
import javax.inject.*;
...
public class ResumeCoordinator
{
    ...
    private final OptimalQuestGuideConfig config;
    ...
    @Inject public ResumeCoordinator(OptimalQuestGuideConfig config, ResumeIntentStore store, QuestHelperBridge bridge)
