...
import com.optimalquestguide.ui.GuidePanel;
import java.io.*;
...
public class OptimalQuestGuidePlugin extends Plugin implements GuidePanel.Actions
{
    @Inject private ClientThread clientThread;
    @Inject private Client client;
    @Inject private ClientToolbar toolbar;
    @Inject private ConfigManager configManager;
    @Inject private OptimalQuestGuideConfig config;
    ...
    @Provides OptimalQuestGuideConfig provideConfig(ConfigManager manager) { return manager.getConfig(OptimalQuestGuideConfig.class); }
    ...
    {
        if (OptimalQuestGuideConfig.GROUP.equals(event.getGroup()) && "resumeQuestOnLogin".equals(event.getKey()))
        {
            long token = generation.get();
