...
public class PluginLifecycleTest
{
    ...
    @InjectMocks private QuestCapePlugin plugin;
    ...
    @Test public void onlyOwnResumePreferenceIsHandledAndShutdownInvalidatesQueuedActions() throws Exception
    {
        ...
        event.setGroup(QuestCapeConfig.GROUP); plugin.onConfigChanged(event); drainClient(); verify(resume).preferenceChanged();
